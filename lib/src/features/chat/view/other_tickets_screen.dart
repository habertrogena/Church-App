...
class OtherTicketsScreen extends StatefulWidget {
  const OtherTicketsScreen({super.key});

  @override
  State<OtherTicketsScreen> createState() => _OtherTicketsScreenState();
}

class _OtherTicketsScreenState extends State<OtherTicketsScreen> {
